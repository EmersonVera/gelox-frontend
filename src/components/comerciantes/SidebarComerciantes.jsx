...
/* ─── Nav Links ── */
const LINKS = [
  { icon: <UsersIcon />, label: 'Mis Comerciantes', to: '/comerciantes' },
];
...
export default function SidebarComerciantes({ open, onClose }) {
  ...
  return (
    ...
    >
      ...
      <div className="px-4 py-5 border-t border-border flex flex-col gap-0.5">
        {/* Ajustes bajo /comerciantes/ para que el dispatcher mantenga esta sidebar */}
        <NavLink to="/comerciantes/ajustes" className={linkClass} onClick={handleNavClick}>
