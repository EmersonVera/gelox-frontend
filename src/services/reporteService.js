...
export async function getGraficaInversionIngresos(fechaInicio, fechaFin) {
    const res = await api.get(
        `/api/reportes/grafica-inversion-ingresos?fechaInicio=${fechaInicio}&fechaFin=${fechaFin}`
    );
